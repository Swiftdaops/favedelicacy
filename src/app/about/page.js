          ...
          {[
            {
              ...
              text: "Prepared by professionals who care about taste and presentation.",
            },
            {
              icon: Flame,
              title: "Fresh Ingredients",
              text: "We cook only with fresh, high-quality ingredients.",
            },
            {
              icon: Truck,
              title: "Fast Delivery",
              text: "Reliable doorstep delivery across Ifite, Awka.",
            },
            {
              icon: Star,
              title: "Trusted by Locals",
              text: "Loved and recommended by customers in our community.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
      ...
      <div className="bg-[#e63a46] py-20">
        ...
        >
          ...
          <p className="mt-4 text-white/90">
            Consistent quality. Honest portions. Reliable delivery.
            Every order is treated like it’s for family.
          </p>
        </motion.div>
      </div>
    </section>
